...
// -------- Flask Server URL --------
// Local:      http://192.168.1.20:2000/api/gps
// Production: https://smart-helmet-rider.onrender.com/api/gps
const char* serverURL = "http://192.168.1.20:2000/api/gps";  // <-- update your IP here

// -------- Helmet Identity --------
// ⚠️ CHANGE THIS for each ESP32 you flash!
// Use format: HELMET_001, HELMET_002, HELMET_003 ...
const char* HELMET_ID = "HELMET_001"; // --> rider ID if meron or number example if pang ilan sila (pwede rin name)
const char* HELMET_NAME = "Rider 1";  // --> lagay nyu n lang dito full name ng rider
