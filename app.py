...
EMAIL_ENABLED = True  # Change to True to enable email
...
def send_reset_email(to_email, username, reset_link):
    ...
    try:
        ...
        msg['To'] = to_email
        msg['Subject'] = "Password Reset - Helmet GPS Tracker"
...
def api_forgot_password():
    ...
    # Create reset link
    reset_link = f"http://192.168.50.227:5000/reset-password/{reset_token}"
